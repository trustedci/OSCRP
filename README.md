...
Welcome to OSCRP, a joint project of the [Center for Trustworthy Scientific Cyberinfrastructure](http://trustedci.org) (CTSC), the [NSF](http://nsf.gov) Cybersecurity Center of Excellence, and the [Department of Energy's Energy Sciences Network (ESnet)](https://www.es.net/).
...
The risk profile is scoped to science projects that are “open,” that is unclassified. E.g. funded by [NSF](http://nsf.gov), [DOE ASCR](http://science.energy.gov/ascr), [NIH](http://www.nih.gov).  (They may be under limited-time scientific embargo, however, and may include PHI, such as with NIH research).

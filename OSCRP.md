...
3. [Who This Document is Intended For](#who)
4. [Introduction](#introduction)
5. [Bad Things Can Happen to Good Science](#badthings)
	a. [Examples of Computer Security Incidents Affecting Research](#examples)
		i. [Untargeted, but disruptive](#untargeted)
		ii. [Possibly targeted](#possiblytargeted)
		iii. [Targeted](#targeted)
6. [How to Use this Document](#how)
7. [Definition of Terms](#definitions)
8. [Usage Example: Embargoed Data Case Study](#usageexample)
9. [Common Open Science Assets](#assets)
	a. [Data Assets](#data)
	b. [Facilities and Hardware Assets](#facilities)
	c. [Software Assets](#software)
	d. [Instruments](#instruments)
	e. [Intangible and Human Assets](#intangible)
10. [Next Steps](#nextsteps)
11. [Conclusions](#conclusions)
12. [Cybersecurity Resources for Open Science](#resources)
...
-   [*Network-connected scientific control systems (e.g., microscopes, telescopes, light sources, particle accelerators)*](http://trustedci.github.io/OSCTP/assets/Network-connected%20scientific%20control%20systems.md)
...
-   [*Project Reputation*](https://docs.google.com/drawings/d/1vXd49PJifpdEvBCoDIwewHPBN4xnnhfpFBz5aJbjXRg/edit): some text….
